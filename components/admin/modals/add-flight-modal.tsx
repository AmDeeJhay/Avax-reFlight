    ...
    try {
      ...
      const payload = {
        ...
        departure: {
          ...
          airport: formData.fromAirport,
        },
        arrival: {
          date: formData.arrivalDate,
          time: formData.arrivalTime,
          airport: formData.toAirport,
        },
        capacity: {
          economy: Number(formData.economySeats),
          business: Number(formData.businessSeats),
          first: Number(formData.firstSeats),
        },
        pricing: {
          economy: Number(formData.economyPrice),
          business: Number(formData.businessPrice),
          first: Number(formData.firstPrice),
        },
      }
        ...
        {isSubmitting ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button type="submit" className="bg-gradient-to-r from-red-500 to-blue-600" disabled={isSubmitting}>
